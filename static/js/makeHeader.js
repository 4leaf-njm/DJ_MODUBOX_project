...
const after_mobile_menu_list = Array.from(
  document.getElementsByClassName("mobile_menu_list_of_one")
);
...
after_mobile_menu_list.map((data, idx) => {
  if (idx !== after_mobile_menu_list.length - 1)
